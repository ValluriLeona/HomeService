...
export default function MechanicalRepair({ store }) {
  ...
  useEffect(() => {
    axios.get("http://localhost:8082/svc/mechanicalrepair")
      .then((res) => {
        setResult(res.data);
        setLoading(false);
      })
  ...
  if (loading) return <div>Mechanical Repair Services List Fetching...</div>;
